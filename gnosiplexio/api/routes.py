...
logger = logging.getLogger("gnosiplexio.routes")
        ...
        with _engine_lock:
            if _engine_instance is None:
                ...
                try:
                    ...
                    logger.info("Veritas adapter initialized: %s", adapter)
                except Exception as e:
                    logger.warning("Veritas adapter not available, starting without adapter: %s", e)
